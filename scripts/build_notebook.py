...
# 1. Define Notebook Cells Content
cells = [
    {
        "cell_type": "markdown",
        "metadata": {},
...
nb_path_root = 'hospital_cleaning.ipynb'
nb_path_scripts = 'scripts/hospital_cleaning.ipynb'

with open(nb_path_root, 'w', encoding='utf-8') as f:
    json.dump(notebook_dict, f, indent=1)

with open(nb_path_scripts, 'w', encoding='utf-8') as f:
    json.dump(notebook_dict, f, indent=1)

print("Generated hospital_cleaning.ipynb successfully.")
